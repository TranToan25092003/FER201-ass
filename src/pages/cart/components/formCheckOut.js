          ...
          <Row style={{ gap: "50px 50px" }}>
            ...
            >
              ...
              >
                ...
                <Form.Control
                  type="text"
                  value={userAccount ? userAccount.id : formData.user.uid}
                  disabled
                />
              </Form.Group>
              <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridEmail">
                  ...
                  <Form.Control
                    type="email"
                    value={
                      userAccount ? userAccount.email : formData.user.uemail
                    }
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        user: { ...formData.user, uemail: e.target.value },
                      })
                    }
                    required
                  />
                ...
                <Form.Group as={Col} controlId="formGridCity">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        user: { ...formData.user, fname: e.target.value },
                      })
                    }
                    required
                  />
                ...
                <Form.Group as={Col} controlId="formGridState">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        user: { ...formData.user, lname: e.target.value },
                      })
                    }
                    required
                  />
              ...
              <Form.Group className="mb-3" controlId="formGridAddress2">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, rDate: e.target.value })
                  }
                  required
                />
              </Form.Group>
              <Form.Group className="mb-3" controlId="formGridAddress1">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      user: { ...formData.user, address: e.target.value },
                    })
                  }
                  required
                />
              ...
              <Form.Group className="mb-3" controlId="formGridAddress2">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      user: { ...formData.user, mobile: e.target.value },
                    })
                  }
                  required
                />
